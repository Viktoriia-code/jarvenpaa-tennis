...
const Aikuisvalmennus = () => {
  return (
    <div className='flex flex-col gap-4'>
      ...
      <div>
        <h3 className='subtitle mb-2'>Aikuisvalmennus kuuden hengen ryhmässä:</h3>
        <p>- Kuuden pelaajan ryhmät (vain uusille ja aloitteleville pelaajille) 19€/tunti eli koko sisäkaudelta 855€ + hallintokulu (laskutuskertojen mukaan) + jäsenmaksu</p>
      </div>

      <div>
        <h3 className='subtitle mb-2'>Aikuisvalmennus neljän hengen ryhmässä:</h3>
        <p>- 25€/tunti/pelaaja (kausimaksu yhdellä viikkotunnilla ilman alennuksia 1125€ + hallintokulu (laskutuskertojen mukaan) + jäsenmaksu</p>
      </div>

      <div>
        <h3 className='subtitle mb-2'>Aikuisvalmennus kolmen hengen ryhmässä:</h3>
        <p>- 30€/tunti/pelaaja</p>
      </div>

      <div>
        <h3 className='subtitle mb-2'>Parivalmennus kahden hengen ryhmässä:</h3>
        <p>- 40€/tunti/pelaaja</p>
      </div>

      <div>
        <h3 className='subtitle mb-2'>Yksityisvalmennus kerran viikossa:</h3>
        <p>- 70€/tunti/pelaaja</p>
      </div>
      <AikuisvalmennusForm />
    </div>
  )
